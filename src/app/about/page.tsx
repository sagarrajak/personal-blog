        ...
        <CardContent className="p-6 sm:p-8 flex flex-col items-center gap-6">
          ...
          <div className="flex-1 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              intuitive user experiences. My current work experience includes:
            </p>
            <ul className="list-disc list-inside text-muted-foreground mb-6 text-left">
              <li>Building responsive web applications using React and Next.js</li>
              <li>Collaborating with cross-functional teams in an agile startup environment</li>
              <li>Implementing modern UI/UX designs with Tailwind CSS and shadcn/ui</li>
              <li>Optimizing web performance and accessibility for a better user experience</li>
            </ul>
